...
using AuthClient.Network.Factory;
using Game;
...
namespace Network.Factory
{
    public class ACFactory : MonoBehaviour
    {
        ...
        private ACFactoryImplementation _factory;
        ...
        private class ACFactoryImplementation : ACNetworkObjectFactory
        {
            private ACFactory _owner;
            private Action<int> OnDestroy;
            private UnityView _unityView;
            public void Initialize(ACFactory owner, UnityView unityView)
            {
                _owner = owner;
